...
public class ObjectFactory {
    ...
    private final static QName _GetClusterVms_QNAME = new QName("http://service.example.org/", "getClusterVms");
    private final static QName _GetClusterVmsResponse_QNAME = new QName("http://service.example.org/", "getClusterVmsResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.org/", name = "getClusterVms")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example.org/", name = "getClusterVmsResponse")
