...
public class ObjectFactory {
    ...
    private final static QName _NotFoundError_QNAME = new QName("http://service.standalone.example.org/", "NotFoundError");
    private final static QName _ValidationError_QNAME = new QName("http://service.standalone.example.org/", "ValidationError");
    ...
    private final static QName _DuplicateError_QNAME = new QName("http://service.standalone.example.org/", "DuplicateError");
    ...
    /**
     * Create an instance of {@link DuplicateErrorFault }
     * 
     */
    public DuplicateErrorFault createDuplicateErrorFault() {
        return new DuplicateErrorFault();
    }
    ...
    /**
     * Create an instance of {@link NotFoundErrorFault }
     * 
     */
    public NotFoundErrorFault createNotFoundErrorFault() {
        return new NotFoundErrorFault();
    }

    /**
     * Create an instance of {@link ValidationErrorFault }
     * 
     */
    public ValidationErrorFault createValidationErrorFault() {
        return new ValidationErrorFault();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NotFoundErrorFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.standalone.example.org/", name = "NotFoundError")
    public JAXBElement<NotFoundErrorFault> createNotFoundError(NotFoundErrorFault value) {
        return new JAXBElement<NotFoundErrorFault>(_NotFoundError_QNAME, NotFoundErrorFault.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ValidationErrorFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.standalone.example.org/", name = "ValidationError")
    public JAXBElement<ValidationErrorFault> createValidationError(ValidationErrorFault value) {
        return new JAXBElement<ValidationErrorFault>(_ValidationError_QNAME, ValidationErrorFault.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DuplicateErrorFault }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.standalone.example.org/", name = "DuplicateError")
    public JAXBElement<DuplicateErrorFault> createDuplicateError(DuplicateErrorFault value) {
        return new JAXBElement<DuplicateErrorFault>(_DuplicateError_QNAME, DuplicateErrorFault.class, null, value);
    }
